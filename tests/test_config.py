...
def test_antideepfake_script_default_points_to_existing_file(monkeypatch):
    # SPAI_REPO_DIR/ANTIDEEPFAKE_REPO_DIR are required for Settings() to construct
    # but their actual values don't matter for this test - only ANTIDEEPFAKE_SCRIPT's
    # computed default does. Values below need not exist on disk.
